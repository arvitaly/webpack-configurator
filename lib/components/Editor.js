...
class EditorComponent extends neweb_components_1.Component {
    beforeMount() {
        ...
        this.addElement("enableDevServer", new neweb_components_1.BooleanInputComponent({
            value: this.props.data.devServer.enabled,
        }));
        this.addElement("txtDevServerContentBase", new neweb_components_1.InputComponent({
